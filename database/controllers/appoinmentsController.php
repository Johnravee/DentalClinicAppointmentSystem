...
$queryMethods = new insertQueries($conn);
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        try{
            $appointedTime = htmlspecialchars($_POST['appointedTime']);
            $appointedDate = htmlentities($_POST['appointedDate']);
            $appointmentTypeModal = htmlentities($_POST['appointmentTypeModal']);
            $Consultant = htmlentities($_POST['consultant']);
            $transactionNumber = htmlentities($_POST['transactionNumber']);
