...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="../src/styles/adminProfile.css?v=<?php echo time() ?>">
...
<body>
    <header>
        ...
        <div class="backBtn">
            <a href="adminDashboard.php"><button type="button"><i class="bi bi-arrow-left-circle"></i></button></a>
        </div>
    </header>
    ...
    <main>
        <form action="/DentalClinicAppointmentSystem/database/controllers/updateProfileController.php"
            ...
            <aside>
                ...
                <div class="sideBtn">
                    <input type="text" name="adminProfileID" value="<?php echo $rows['adProfile_ID'] ?>" hidden />
                    ...
                    <div class="formContainer">
                        ...
                        <div class="formGroup">
                            ...
                            <input id="email" type="email" name="email" class="input"
                                value="<?php echo $rows['email'] ?>" readonly />
                        </div>
